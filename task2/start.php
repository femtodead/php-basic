    ...
    function mathOperation($arg1, $arg2, $operation)
    {
        if (is_numeric($arg1) && is_numeric($arg2))   {
           switch ($operation) {
            ...
            case '/':
                if ($arg2 == 0) {
                    echo "на 0 делить нельзя, возращаю null \n";
                    return null;
                }else{
                    return $arg1 / $arg2;
                }
            default:
                echo "В данной функции можно использовать 4 операции - + * /, возращаю null\n";
                return null;
           }
        } else{
            echo "Один из аргументов или оба не являются числом, возращаю null\n";
            return null;
        }
    };
