...
function parseCommand() : string {
    ...
    if(isset($_SERVER['argv'][1])) {
        $functionName = match($_SERVER['argv'][1]) {
            ...
            'help' => 'helpFunction',
            'search' => 'searchFunction', //4. Добавьте новые функции в итоговое приложение работы с файловым хранилищем.
            'del' => 'delFunction', //4. Добавьте новые функции в итоговое приложение работы с файловым хранилищем.
